...
function BatchLauncher({duration,allocation,maxPositions,disabled,onLaunched}:{duration:number;allocation:number;maxPositions:number;disabled:boolean;onLaunched:()=>void}) {
  ...
  const launch=async()=>{
    ...
    try{
      const body={base:{duration_seconds:duration,allocation_per_position:allocation,max_positions:maxPositions,entry_mode:'THREE_BAR',exit_mode:'RATCHET',require_nifty_confirmation:true},
                  account_prefix:'fwd',
